"""
 ...
 The dynamic data used in this example is real and originates from a 
 buck-boost DC-DC converter, limited to the range of 2 to 2.5 V. Meanwhile, 
 the static data is theoretical and covers the range of 1 to 5 V. The aim is 
 for the dynamic model, even with limited data, to represent other operating 
 points based on the information contained in the theoretical static curve.
...
# Creates the static validation data
uest = linspace(1, 5, 15)
Vd = 24
yest = ((4 * Vd) / 3) - (Vd / 3) * uest
...
yest2, eqest = displayStaticModel(staticModel, uest, y, 1)
...
plot(uest, yest2, 'r-.', label="Simulated Data")
