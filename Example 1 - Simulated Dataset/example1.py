"""
 ...
 The data used in this example was generated by AI and presents differences 
 between dynamic and static characteristics to simulate real usage conditions.
...
from matplotlib.pyplot import (
    figure, subplot, plot, title, ylabel, xlabel, legend, grid, box, close, 
    suptitle
)
...
data = loadmat('dynamic.mat')
datas = loadmat('static.mat')
ti = data['ti'].flatten()
ui = data['ui'].flatten()
yi = data['yi'].flatten()
tv = data['tv'].flatten()
...
Model = removeClusters(Model,3,0);
Model = removeClusters(Model,2,0);
Model = removeClusters(Model,2,1);
Model = removeClusters(Model,1,1);
Model = removeClusters(Model,1,2);
